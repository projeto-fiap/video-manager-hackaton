...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, VideoProducerDTO> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, VideoProducerDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
